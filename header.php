          ...
          <div class="row">
            <div class="col-xs-12 col-sm-12">
              <div class="header-top-left">
                <div class="contact"><a href="../tel:0359003130"><i class="fas fa-phone"></i> Gọi Ngay !</a> <span>0359003130</span> || 
            ...
            <div class="col-xs-12 col-sm-4">
              <div class="main-search mt_40">
                <form action="<?php bloginfo('url'); ?>/" method="get">
                  <input required id="search-input" name="s" placeholder="Tìm Kiếm" class="form-control input-lg" autocomplete="off" type="text">
            ...
            <div class="col-xs-6 col-sm-4 shopcart">
              ...
              <div id="cart" class="btn-group btn-block mtb_40">
                <button type="button" class="btn" data-target="#cart-dropdown" data-toggle="collapse" aria-expanded="true">
                  <span>
                      <?php echo sprintf (_n( 'Giỏ hàng <br> (%d) ', 'Giỏ hàng <br> (%d)', WC()->cart->cart_contents_count ), WC()->cart->cart_contents_count ); ?>
                  </span> Sản Phẩm </span> </button>
              </div></a>
            </div>
          </div>
        </div>
